    ...
    <tbody>
        @foreach ($categories as $category)
            <tr>
                ...
                <td>
                    <a href="{{ route('category.show', $category->id) }}" class="btn btn-primary mt-2 mb-2">Ver</a>
                    <a href="{{ route('category.edit', $category->id) }}" class="btn btn-success mt-2 mb-2">Actualizar</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form id="formDelete" data-action="{{ route('category.destroy', 0) }}" method="POST">
                    @method('DELETE')
                    @csrf
